...
export default class extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      table.increments('id')
      table.integer('id_substation', 10)
        .notNullable()
        .unsigned()
        .index()
        .references('substations.id')
      table.integer('id_type_defect', 10)
        .notNullable()
        .unsigned()
        .index()
      ...
      table.integer('id_user', 10)
        ...
        .unsigned()
        .index()
      table.integer('id_intermediate_check', 10)
        .unsigned()
        .index()
        .references('intermediate_checks.id')
      ...
      table.integer('id_name_eliminated', 10)
        .unsigned()
        .index()
        .references('staff.id')
