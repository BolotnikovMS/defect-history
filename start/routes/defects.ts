...
Route.group(() => {
  ...
  Route.get('/delete/:id', 'DefectsController.destroy').as('destroy').middleware(['auth'])
  Route.get('/delete-img/:id', 'DefectsController.deleteImg').as('delete.img').middleware(['auth'])
