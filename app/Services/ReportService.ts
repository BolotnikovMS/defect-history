...
export default class ReportService {
  ...
  public static async createExcelAllDefectsTM(req: RequestContract) {
    ...
    defects.forEach((defect) => {
      worksheet.addRow({
        createdAt: defect.created_at.toFormat('dd.MM.yyyy'),
        ...
        termElimination: defect.term_elimination.toFormat('dd.MM.yyyy'),
